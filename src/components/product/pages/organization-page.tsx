...
type Props = { tab: OrganizationTab; setTab: (tab: OrganizationTab) => void; organization: Organization; agents: Agent[]; notify: Notify; updateOrganization: (updates: Partial<Organization>) => void };

export function OrganizationPage({ tab, setTab, organization, agents, notify, updateOrganization }: Props) {
