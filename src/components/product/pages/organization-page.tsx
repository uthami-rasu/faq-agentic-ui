...
import { Activity, AlertCircle, Bot, Building2, Code2, Pencil, Save, UserRound, WandSparkles, X } from "lucide-react";
...
export function OrganizationPage({ tab, setTab, organization, agents, notify, updateOrganization, canEdit, canDelete }: Props) {
  ...
  return <>
    ...
    {tab === "activity" && <ActivityTimeline organizationId={organization.id} title={`${organization.name} activity`}/>}
