...
import type { AdminAccessDto, CurrentUserDto } from "@/lib/api";
...
export function AdminWorkspace({ view, data, currentUser, changeView, refresh }: WorkspaceProps) {
  ...
  return <section className="governance-workspace">
    ...
    {view === "users" && <UsersPanel data={data} refresh={refresh}/>} 
