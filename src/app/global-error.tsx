...
export default function GlobalError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return <html lang="en"><body style={{ margin: 0 }}><main style={{ minHeight: "100vh", display: "grid", placeItems: "center", padding: 24, background: "#f8f9fc", color: "#202124", fontFamily: "Inter, Arial, sans-serif" }}>
    <section style={{ width: "min(520px, 100%)", textAlign: "center" }}>
      ...
      <p style={{ margin: "0 auto", maxWidth: 440, color: "#5f6368", fontSize: 15, lineHeight: 1.65 }}>Arffy AI couldn’t finish loading, but a fresh attempt usually gets everything moving again.</p>
      <button onClick={reset} style={{ marginTop: 25, padding: "11px 22px", border: 0, borderRadius: 8, color: "white", background: "#168c86", fontSize: 14, fontWeight: 700, cursor: "pointer", boxShadow: "0 5px 15px rgba(22,140,134,.22)" }}>Reload Arffy AI</button>
    </section>
  </main></body></html>;
}
