...
export default async function Workspace({ searchParams }: { searchParams: WorkspaceSearchParams }) {
  ...
  const accessToken = cookieStore.get("arffy-ai-access-token")?.value ?? cookieStore.get("querydesk-access-token")?.value;
